...
<script type="text/javascript" charset="utf-8" src="/static/Admin/ueditor/lang/zh-cn/zh-cn.js"></script>
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">公告修改</font></font></h4>
                <form class="forms-sample" action="/adminarticle/{{$info->id}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" id="exampleInputPassword4" value="{{$info->title}}">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword4"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">图片</font></font></label>
                        <input type="file" name="thumb" class="form-control" id="exampleInputPassword4" placeholder="图片" value="{{$info->thumb}}">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword4"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">描述</font></font></label>
                        <script id="editor" type="text/plain" name="descr" style="width:900px;height:250px;">{!!$info->descr!!}</script>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword4"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">作者</font></font></label>
                        <input type="text" name="editor" class="form-control" id="exampleInputPassword4" value="{{$info->editor}}">
                    </div>
                    {{csrf_field()}}
                    {{ method_field('PUT') }}
