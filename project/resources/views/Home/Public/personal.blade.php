        ...
        <!--End 所在收货地区 End-->
         <span class="fr">
            ...
            @if(empty(session('username')))
                ...
                <!--退出-->
            &nbsp;&nbsp;
        <a href="/loginout">退出</a>&nbsp;&nbsp;|<a href="/home">返回首页</a>
        @endif
        &nbsp;|<a href="#">我的订单</a>&nbsp;|</span>
          <span class="ss">
              <div class="ss_list">
...
<div class="m_top_bg">
    <div class="top">
        <div class="m_logo"><a href="Index.html"><img src="/static/Home/images/logo1.png" /></a></div>
        <div class="m_search">
            <form>
        ...
        <div class="i_car">
            <a @if(session("username")) href="/shoppingcart" @endif><div class="car_t">购物车</div></a>
            @if(!session("username"))
                <div class="car_bg">
                    <!--Begin 购物车未登录 Begin-->
                    <div class="un_login">还未登录！<a href="/homelogin" style="color:#ff4e00;">马上登录</a> 查看购物车！</div>
                </div>
            @endif
        </div>
    </div>
          ...
          <div class="left_n">管理中心</div>
            <div class="left_m">
              <div class="left_m_t t_bg1">订单中心</div>
                <ul>
                  <li><a href="/personalorder">我的订单</a></li>
            ...
            <div class="left_m">
              <div class="left_m_t t_bg2">会员中心</div>
                <ul>
                  <li><a href="/personal">用户信息</a></li>
                  <li><a href="/pj">我的评价</a></li>
                </ul>
            </div>
        </div>
    @section("main")
