<?php
	...
	function sendsphone($p){
		...
		$options['accountsid']='c212f3216200b046badd7e70a56c7775';
		//填写在开发者控制台首页上的Auth Token
		$options['token']='1f818ecd3f973697b8feb1e1ae8722ec';
		//初始化 $options必填
		$ucpass = new Ucpaas($options);
		$appid = "3356895eea944c02a526b2c895708644";	//应用的ID，可在开发者控制台内的短信产品下查看
		$templateid = "481276";    //可在后台短信产品→选择接入的应用→短信模板-模板ID，查看该模板ID
		//发送的校验码
		$param = rand(1,10000); //多个参数使用英文逗号隔开（如：param=“a,b,c”），如为参数则留空
		\Cookie::queue("fcode",$param="1",1);
		// return response('kalaok')->withCookie("fcode",$param,2);
		// session(['fcode'=>'$param']);
		//接收短信的手机号
		$mobile = $p;
		$uid = "";
